  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-brand-gray/30 bg-brand-white px-1 py-1.5 flex items-center justify-around safe-area-inset-bottom">
      ...
      >
        ...
        <span className="text-[9px] leading-tight font-medium uppercase tracking-wide">Port.</span>
      </button>
      ...
      >
        ...
        <span className="text-[9px] leading-tight font-medium uppercase tracking-wide">Connect</span>
      </button>
