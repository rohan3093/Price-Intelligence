...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-brand-gray/20 bg-brand-white px-2 py-2 flex items-center justify-around text-xs font-body safe-area-inset-bottom">
      {/* Market */}
      <button
