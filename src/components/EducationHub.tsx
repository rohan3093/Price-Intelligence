      ...
      <main className="flex-1 bg-brand-white px-3 py-3 md:px-4 md:py-4 pb-20 md:pb-4 max-w-7xl mx-auto">
        ...
        <article className="border border-brand-gray/30 p-4 bg-brand-white" style={{ borderRadius: '0px' }}>
          <div className="flex items-center gap-2 mb-3 pb-3 border-b border-brand-gray/20">
            ...
            <span className="text-[10px] text-brand-black/60 uppercase tracking-wide leading-tight">{selectedGuide.estimatedTime}</span>
          </div>
          <h1 className="text-xl md:text-2xl font-heading font-normal text-brand-black mb-2 leading-tight">
            {selectedGuide.title}
          </h1>
          <p className="text-xs text-brand-black/70 mb-4 leading-tight">{selectedGuide.description}</p>
          <div className="prose prose-sm max-w-none text-xs font-body text-brand-black leading-snug">
            <ReactMarkdown
              components={{
                ...
                blockquote: ({ children }) => (
                  <blockquote className="border-l-4 border-brand-black pl-3 py-1.5 my-2.5 bg-brand-gray/5 italic text-xs text-brand-black leading-snug">
                    {children}
                  </blockquote>
                ),
              }}
        ...
        {filteredGuides.map((guide) => (
          ...
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <span className="text-[10px] text-brand-black/60 uppercase tracking-wide leading-tight">{guide.estimatedTime}</span>
            </div>
            <h3 className="text-sm font-semibold text-brand-black mb-1 leading-tight">
              {guide.title}
            </h3>
            <p className="text-xs text-brand-black/70 leading-snug">{guide.description}</p>
          </button>
        ))}
      </div>
    </main>
